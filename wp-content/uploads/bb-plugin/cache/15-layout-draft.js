...
var wpAjaxUrl = 'http://dales.wemes.com.ua/wp-admin/admin-ajax.php';var flBuilderUrl = 'http://dales.wemes.com.ua/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig = {
	...
	paths : {
		pluginUrl : 'http://dales.wemes.com.ua/wp-content/plugins/beaver-builder-lite-version/',
		wpAjaxUrl : 'http://dales.wemes.com.ua/wp-admin/admin-ajax.php'
	},
	breakpoints : {
		small  : 768,
		medium : 992	},
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5b4348998f97b .fl-photo-img' )
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5b434c9d0fb6b .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5b434d6d041b6 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
