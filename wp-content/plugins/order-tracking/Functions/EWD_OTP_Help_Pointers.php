...
function EWD_OTP_Return_Pointers() {
  ...
  $pointers['tutorial-four'] = array(
    ...
    'content'   => "<div><p>You can create as many different email update messages as you'd like. Different messages can be set to go out whenever an order is set to a certain status (ex. 'Completed' status could have a message saying 'Order completed ... etc.')</p></div><div class='ewd-otp-pointer-count'><p>4 of 7</p></div>",
    'anchor_id' => '#Emails_Menu',
    'edge'      => 'top',
    'align'     => 'left',
    'nextTab'   => 'Options',
    'width'     => '320',
