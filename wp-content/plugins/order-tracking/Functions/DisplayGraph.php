...
function EWD_OTP_Display_Graph($OrderNumber) {
	...
	if ($Browser == "ie") {
		...
		if (($Display_Graphic == "Default") or ($Display_Graphic == "Streamlined") or ($Display_Graphic == "Sleek")) {  
			...
			if ($CurrentPercent == 0 or $CurrentPercent == 100) {
				$ReturnString .= "<div id='ewd-otp-progressbar-" . $Display_Graphic . "'><div class='" . $Display_Graphic . "' style='width: " . $CurrentPercent . "%'></div></div>";
				$ReturnString .= "<div class='ewd-otp-statuses'>";
				$ReturnString .= "<div class='ewd-otp-display-status' id='ewd-otp-initial-status'>" . ($CurrentPercent == 0 ? $CurrentStatus : $StartingStatus) . "</div>";
				$ReturnString .= "<div class='ewd-otp-display-status' id='ewd-otp-ending-status'>" . ($CurrentPercent == 100 ? $CurrentStatus : $EndingStatus) . "</div>";
				$ReturnString .= "</div>";
