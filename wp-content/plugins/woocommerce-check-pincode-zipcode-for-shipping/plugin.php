	...
	function pincode_field( $product ) {
		...
		if($product_type != 'external' && $_product->is_downloadable('yes') != 1 && $_product->is_virtual ('yes') != 1) 
		{
			...
			if(isset($cookie_pin) && $cookie_pin != '') {
				...
				<span class='avlpin' id='avlpin'><p><?php esc_html_e('Available at','pho-pincode-zipcode-cod'); ?> <?php echo esc_html( $cookie_pin ); ?></p><a class="button" id='change_pin'><?php esc_html_e('change','pho-pincode-zipcode-cod'); ?></a></span>

				<div class="pin_div" id="my_custom_checkout_field2" style="display:none;">

						<div class="error_pin" id="error_pin" style="display:none"><?php esc_html_e('Oops! We are not currently servicing your area.','pho-pincode-zipcode-cod'); ?></div>

						<p id="pincode_field_idp" class="form-row my-field-class form-row-wide">

							<label class="" for="pincode_field_id"><?php esc_html_e('Check Availability At','pho-pincode-zipcode-cod'); ?></label>
							...
							<a class="button" id="checkpin"><?php esc_html_e('Check','pho-pincode-zipcode-cod'); ?></a>
				...
				<div class="delivery-info-wrap">
					...
					<div class="delivery-info">
							...
							<div class="header">
								...
								<span><h6><?php esc_html_e('Delivered By','pho-pincode-zipcode-cod'); ?></h6></span>
